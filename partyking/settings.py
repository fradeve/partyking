...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/fradeve/git/partyking/database.db',
    }
}
...
SECRET_KEY = 't=9l)f6y*+)!)j12_&snig99w=r*p)e@s-uc8h(g#89zqr4*7*'
...
ROOT_URLCONF = 'partyking.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'partyking.wsgi.application'
